...
namespace CompanyPrinterz.Models
{
    ...
    public partial class CompanyPrintersEntities : DbContext
    {
        public CompanyPrintersEntities()
            : base("name=CompanyPrintersEntities")
        {
        }
        ...
        public virtual DbSet<PrinterMakeTbl> PrinterMakeTbls { get; set; }
